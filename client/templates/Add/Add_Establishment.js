...
Template.AddEstablishment.events({
  "click #addEstablishment": function (e) {
    e.preventDefault();
    var Category = $("#category-select").val();
    var Name = $(".E_name").val();
    var Description = $(".E_description").val();
    var MunicipalityE = $(".Ea_municipality").val();
    var BarangayE = $(".Ea_barangay").val();
    ...
    Meteor.call('addEstab', Category, Name, Description, MunicipalityE, BarangayE, Street, Longi, Lati, ConNum, FaxNum, Email, Website, es_ID);
